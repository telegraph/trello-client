...
*/
    ...
    moveList(toBoardId, fromListId, toListName, pos = 'bottom') {
        return this._client.put(`/lists/${fromListId}?name=${toListName}&closed=false&idBoard=${toBoardId}&pos=${pos}`);
    }
     ...
     *
     * @param list {{id:String, name?:String}} List object to be updated
     * @returns {Promise<*>}
     **/
    update(list){
        if( !list.id ){
