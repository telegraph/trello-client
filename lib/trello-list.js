...
class TrelloLists {
    ...
    moveList(listId, toBoardId, toListName) {
        return this._client.put(`/lists/${listId}?name=${toListName}&closed=false&idBoard=${toBoardId}`);
    }
     ...
     */
    copyList(fromListId, toBoardId, toListName) {
        return this._client.post(`/lists/?name=${encodeURIComponent(toListName)}&idBoard=${toBoardId}&idListSource=${fromListId}`);
    }
